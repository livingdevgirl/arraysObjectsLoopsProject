...
Push any numbers less than 10 onto
"smallNums". Return "smallNums".
*/
...
console.log(smallNumsArray)


/*
3. Add 12, 99, and 101 (in that order)
to the end of the "numbers" array.
...
/*
5. Add the name "Yukiko Shimazaki" to the "actors" array.
 Return "film";
*/
function addActor(){
    film.actors[film.actors.length] = "Yukiko Shimazaki"
    return film
}

/*
6. Now that you've added a "boxoffice" property,
subtract "budget" from "property" and return the difference.
This number is the amount lost by the studio in making the film.
Return the loss.
*/
function getLosses(){
    let studioLoss = (film.boxoffice - film.budget);
    return studioLoss
}
...
/*
7. Iterate over "letterVals" and "numberVals".
Concatenate the values from the two arrays and
store the new values in the "vals" array. Return "vals".
...
//      Concatenate numberVals and letterals and store them in new array
...
/*
8. Iterate over the "first" and "second" arrays.
Compare the values for both arrays. If the arrays values are the same,
